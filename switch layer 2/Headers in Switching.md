...
4. [Key Component: Destination MAC Address](#4-key-component-destination-mac-address)
5. [Key Component: Source MAC Address](#5-key-component-source-mac-address)
6. [Key Component: EtherType / Length Field](#6-key-component-ethertype--length-field)
7. [Safety & Security Features](#7-safety--security-features)
8. [Who created the Ethernet Header](#8-who-created-the-ethernet-header)
9. [Types / Variations of Switching Headers](#9-types--variations-of-switching-headers)
...
## 4. Key Component: Destination MAC Address
...
## 5. Key Component: Source MAC Address
...
## 6. Key Component: EtherType / Length Field
...
## 8. Who created the Ethernet Header
...
## 9. Types / Variations of Switching Headers
